...
// Motors
#define MOTOR_SET_ON HAL_GPIO_WritePin(GPIOA, GPIO_PIN_5, 1);
#define MOTOR_SET_OFF HAL_GPIO_WritePin(GPIOA, GPIO_PIN_5, 0);
#define MOTORR_FORWARD HAL_GPIO_WritePin(GPIOA, GPIO_PIN_8, 0);
#define MOTORR_BACK HAL_GPIO_WritePin(GPIOA, GPIO_PIN_8, 0);
#define MOTORL_FORWARD HAL_GPIO_WritePin(GPIOA, GPIO_PIN_8, 0);
#define MOTORL_BACK HAL_GPIO_WritePin(GPIOA, GPIO_PIN_8, 0);
#define MOTORR_CH1 TIM_CHANNEL_1
#define MOTORR_CH2 TIM_CHANNEL_2
#define MOTORL_CH1 TIM_CHANNEL_3
#define MOTORL_CH2 TIM_CHANNEL_4
