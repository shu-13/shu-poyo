...
// Motors
#define MOTOR_MODE_SET_PE HAL_GPIO_WritePin(GPIOA, GPIO_PIN_5, 1);
// #define MOTORR_FORWARD HAL_GPIO_WritePin(GPIOA, GPIO_PIN_11, 0);
// #define MOTORR_BACK HAL_GPIO_WritePin(GPIOA, GPIO_PIN_11, 1);
#define MOTORL_FORWARD HAL_GPIO_WritePin(GPIOA, GPIO_PIN_8, 0);
#define MOTORL_BACK HAL_GPIO_WritePin(GPIOA, GPIO_PIN_8, 1);
#define MOTORR_CH1 TIM_CHANNEL_3
// #define MOTORR_CH2 TIM_CHANNEL_4
// #define MOTORL_CH1 TIM_CHANNEL_1
